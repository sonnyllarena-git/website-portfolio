  ...
  return (
    <section id="about" className="py-24 px-6 relative">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="w-64 h-72 md:w-80 md:h-96 border-2 border-black dark:border-white rounded-2xl bg-white/40 dark:bg-white/5 flex items-center justify-center relative overflow-hidden transition-transform duration-400 ease-out hover:scale-105">
