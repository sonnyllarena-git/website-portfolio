  ...
  return (
    ...
    >
      ...
      >
        {SOCIAL_LINKS.map((social) => (
          <motion.a
            ...
            className="text-black/60 dark:text-white/60 hover:text-accent hover:scale-110 hover:drop-shadow-[0_0_6px_rgba(255,107,53,0.6)] transition-all duration-300 ease-in-out"
          >
            <social.icon size={18} />
          </motion.a>
        ))}
      ...
      <div className="max-w-6xl mx-auto px-6 w-full grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          <div className="profile-neon w-64 h-64 md:w-80 md:h-80 border-2 border-black dark:border-white rounded-2xl bg-white/40 dark:bg-bg-dark flex items-center justify-center relative overflow-hidden">
